...
// Check for error messages in session (passed from register.php or login logic)
...
<body>
    ...
    <div class="container" id="register" style="display: none;">
        ...
        <form action="register.php" class="form" method="post">
            <input required class="input" type="text" name="name" placeholder="Enter Your Name">
            <input required class="input" type="email" name="email" placeholder="E-mail">
            <input required class="input" type="password" name="password" placeholder="Password">
